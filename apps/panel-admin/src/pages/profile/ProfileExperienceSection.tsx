...
import { useProfileStore, type EmploymentHistory } from "@/store/profile.store"
...
export function ProfileExperienceSection() {
  ...
  const { employmentHistory, addEmploymentHistory, updateEmploymentHistory, deleteEmploymentHistory } = useProfileStore()
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      if (editingId) {
        ...
        await addEmploymentHistory(user.id, payload)
      ...
      <div className="flex items-center justify-between border-b border-border pb-3">
        <div>
          ...
          <p className="text-xs text-muted-foreground">
            Añade tu historial de empleo y roles para complementar tu perfil.
          </p>
        </div>
      ...
      {employmentHistory.length === 0 ? (
        <div className="p-12 text-center text-muted-foreground text-sm border border-dashed border-border rounded-xl bg-card/20 space-y-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              Comienza añadiendo tu experiencia laboral haciendo clic en el botón de arriba.
            </p>
          </div>
        </div>
      ) : (
                ...
                <AlertDialog>
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        ¿Estás seguro de que deseas eliminar tu cargo de "{item.role}" en "{item.organization}"? Esta acción no se puede deshacer.
                      </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
      ...
      <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
        <SheetContent side="right" className="w-full sm:max-w-md">
          <SheetHeader>
            ...
            <SheetDescription>
              Completa los detalles de tu trayectoria laboral. Los campos marcados con * son obligatorios.
            </SheetDescription>
          </SheetHeader>
            ...
            <FieldGroup>
              ...
              <div className="flex items-center justify-between p-1 bg-muted/10 border border-border/50 rounded-xl px-4 py-3">
                <div className="space-y-0.5">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Marcar si este es tu empleo actual.
                  </p>
                </div>
                <Switch
                  id="currJob"
              ...
              <div className="flex items-center justify-between p-1">
                <div className="space-y-0.5">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Aparecerá resaltado al inicio de tu biografía.
                  </p>
                </div>
                <Switch
                  id="favJob"
