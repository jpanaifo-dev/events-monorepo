    ...
    <div className="bg-card border border-border rounded-xl shadow-xs p-6 space-y-4">
      <div className="flex items-center justify-between border-b border-border pb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-bold text-base text-foreground font-sans">Calendario</h3>
        </div>
        <span className="text-xs font-semibold text-muted-foreground bg-muted px-2.5 py-0.5 rounded-full uppercase tracking-wider">
      ...
      <div className="grid grid-cols-7 gap-1 text-center text-xs">
        {days.map((item, idx) => (
          <div
            key={idx}
            className={`py-1.5 flex items-center justify-center rounded-lg font-medium transition-colors ${item.isToday
...
export function DashboardPage() {
  ...
  const { events, speakers, attendees, isLoading, loadData } = useEventStore()
  ...
  // Fetch dashboard data automatically on mount / selected org change
  useEffect(() => {
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-3 animate-in fade-in duration-300">
      ...
      {/* Left/Main Column: Banner, Cards, Upcoming Events, Recent Attendees */}
      <div className="lg:col-span-2 space-y-8">
        ...
        <div className="grid gap-4 grid-cols-1 sm:grid-cols-3">
          {isLoading ? (
            Array.from({ length: 3 }).map((_, i) => (
              <div key={i} className="bg-card border border-border rounded-xl p-6 flex flex-col justify-between space-y-4">
        ...
        <div className="bg-card border border-border rounded-xl shadow-xs overflow-hidden">
          <div className="px-6 py-4 border-b border-border flex items-center justify-between">
            <div className="flex items-center gap-2">
              <Calendar className="size-4.5 text-indigo-500" />
              <h2 className="font-bold text-base text-foreground font-sans">Gestión de Próximos Eventos</h2>
            </div>
            <button
        ...
        <div className="bg-card border border-border rounded-xl shadow-xs overflow-hidden">
          <div className="px-6 py-4 border-b border-border flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h2 className="font-bold text-base text-foreground ml-1 font-sans">Inscripciones Recientes</h2>
            </div>
            <button
      ...
      {/* Right Column (Aside): Calendar, Event distribution, Quick Actions */}
      <aside className="space-y-6">

        {/* 1. Mini Calendar */}
        <MiniCalendar />

        {/* 2. Event Status distribution breakdown */}
        <div className="bg-card border border-border rounded-xl shadow-xs p-6 space-y-4">
          <div className="flex items-center gap-2 border-b border-border pb-3">
            <Tag className="size-4.5 text-indigo-500" />
            <h3 className="font-bold text-base text-foreground font-sans">Distribución de Eventos</h3>
          </div>
        ...
        <div className="bg-card border border-border rounded-xl shadow-xs p-6 space-y-4">
          <div className="flex items-center gap-2 border-b border-border pb-3">
            ...
            <h3 className="font-bold text-base text-foreground font-sans">Accesos Rápidos</h3>
          </div>
          ...
          <div className="grid gap-2.5">
            ...
            >
              ...
              <div className="space-y-0.5">
                ...
                <span className="text-xs text-muted-foreground block">Registra una nueva conferencia</span>
              </div>
            </button>
            ...
            >
              ...
              <div className="space-y-0.5">
                ...
                <span className="text-xs text-muted-foreground block">Añade participantes directamente</span>
              </div>
            </button>
            ...
            >
              ...
              <div className="space-y-0.5">
                ...
                <span className="text-xs text-muted-foreground block">Edita las ubicaciones físicas</span>
              </div>
            </button>
