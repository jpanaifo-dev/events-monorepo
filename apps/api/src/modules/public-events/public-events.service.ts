...
export class PublicEventsService {
  ...
  async get(organizationSlug: string, eventId: string) {
    ...
    return { ...item, editions, heroMedia: heroMedia?.media ?? null };
  }
}
